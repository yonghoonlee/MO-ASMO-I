...
%===============================================================================
% Plot Figure 06: Hypervolume metric and Hypervolume metric convergence
%===============================================================================
try figure(fg6); % Open figure window
catch, fg6 = figure('Color',[1 1 1]); end; fg6.Position = [470 520 560 220];
hold off;
try figure(fg7); % Open figure window
catch, fg7 = figure('Color',[1 1 1]); end; fg7.Position = [910 500 560 220];
hold off;
%-------------------------------------------------------------------------------
figure(fg6);
yyaxis left;
...
%-------------------------------------------------------------------------------
yyaxis right;
ph2 = plot(1:k,R.data.c38_hypervolumeRatio, ...
...
%-------------------------------------------------------------------------------
legend([ph1, ph2], ...
    {'hypervolume size', 'hypervolume ratio'}, ...
