...
function prob = settings(prob)
    ...
    prob.bound.flb = [0.0; -1.00];
    prob.bound.fub = [1.0;  0.20];
    ...
    prob.sampling.initnumber = 62;  % initial
    prob.sampling.valnumber = 20;    % validation
    prob.sampling.upnumber = 21;    % exploitation
    prob.sampling.upexpnumber = 21;  % exploration
...
function f = obj(x,param)
    ...
    % Objective functions
    tstar = (2/(pi*ro^3)*M)/(eta*(Omega*ro)/hmin);
    f = [tstar;-Fn];
