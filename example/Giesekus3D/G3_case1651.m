...
function prob = settings(prob)
    ...
    prob.sampling.initnumber = 48;  % initial
    prob.sampling.valnumber = 16;    % validation
    prob.sampling.upnumber = 16;    % exploitation
    prob.sampling.upexpnumber = 16;  % exploration
