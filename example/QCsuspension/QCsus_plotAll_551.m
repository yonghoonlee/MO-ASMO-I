...
load(fullfile(mpath,'solution','QCsus_1ModeMaxwell551_final.mat'),'result');
...
% 2 MODE
[mpath,~] = fileparts(mfilename('fullpath'));
load(fullfile(mpath,'solution','QCsus_2ModeMaxwell551_final.mat'),'result');
...
% 3 MODE
[mpath,~] = fileparts(mfilename('fullpath'));
load(fullfile(mpath,'solution','QCsus_3ModeMaxwell551_final.mat'),'result');
...
% 4 MODE
[mpath,~] = fileparts(mfilename('fullpath'));
load(fullfile(mpath,'solution','QCsus_4ModeMaxwell551_final.mat'),'result');
...
% 10 MODE
[mpath,~] = fileparts(mfilename('fullpath'));
load(fullfile(mpath,'solution','QCsus_10ModeMaxwell551_final.mat'),'result');
...
% LN RESULTS
[mpath,~] = fileparts(mfilename('fullpath'));
load(fullfile(mpath,'solution','QCsus_LogNormal551_final.mat'),'result');
